...
const InPartCard = ({route, navigation}) => {
  ...
  useEffect(() => {
    if (part == 'L1') {
      ...
      setDirections(
        'In this part of the test, you will write an essay in response to a question that asks you to state, explain, and support your opinion on an issue.\n\nYour response will be scored on whether your opinion supported with reasons and/or examples, grammar, vocabulary and organization. \n\nYou will have 30 minutes to plan, write, and revise your essay.',
      );
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
        ...
        <View
          ...
          <View style={{flexDirection: 'column'}}>
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Text
                style={[styles.TextFont, {fontWeight: '300', marginRight: 5}]}>
                Progress:
              </Text>
              <Progress.Bar
                progress={MaxQ > 0 ? MaxQ / sum : 0.0}
                width={120}
                height={10}
                style={{height: 10}}
                color={PRIMARY_COLOR}
        ...
        {/* {questionList&& */}
        <TouchableOpacity
          style={[AppStyle.button.button2, {marginTop: 70, zIndex: 0}]}
          onPress={() =>
