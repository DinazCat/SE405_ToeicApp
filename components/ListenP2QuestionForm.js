...
const ListenP2QuestionForm = React.memo(({item, list, click, flag, check}) => {
          ...
          <View
            ...
            <TouchableOpacity
              style={[
                ...
                sign == 'A' && styles.answerboxStyleTrue,
              ]}
              onPress={() => {
                setsign('A'), click(0);
              }}>
            ...
            <TouchableOpacity
              style={[
                styles.answerboxStyle,
                sign == 'B' && styles.answerboxStyleTrue,
              ]}
              onPress={() => {
                setsign('B'), click(1);
              }}>
            ...
            <TouchableOpacity
              style={[
                styles.answerboxStyle,
                sign == 'C' && styles.answerboxStyleTrue,
              ]}
              onPress={() => {
                setsign('C'), click(2);
              }}>
