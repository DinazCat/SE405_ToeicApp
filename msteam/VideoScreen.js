          ...
          renderItem={({item}) => (
            <TouchableOpacity
              ...
              <View style={styles.imageContainer}>
                ...
                <Image source={{uri: item.snippet.thumbnails?.default?.url}} style={styles.image} />
              </View>
              <View style={{justifyContent: 'space-between'}}>
                ...
                <View
                  ...
                  <Image
                    source={{uri: 'https://yt3.googleusercontent.com/ytc/AIdro_l_fFETDQgTAl5rWb38pxJww-4kszJH_n0G4fKP1BdK-jc=s160-c-k-c0x00ffffff-no-rj'}}
