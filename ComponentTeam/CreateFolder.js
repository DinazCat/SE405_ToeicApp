...
import Api from '../api/Api';
  ...
  const  CreateFolder = ({close, teacherName, classId, navigation}) => {
    ...
    return (
        <View style={{ height:200,width:350, borderRadius:15 ,backgroundColor:'white',borderColor:'black', borderWidth:2, alignSelf:'center', marginVertical:300,backgroundColor:'white', position:'absolute'}}>
            <View style={{flexDirection:'row', height:50, alignItems:'center', justifyContent:"space-between"}}>
            <Text style={{    fontSize: 20, marginLeft: 5, color: 'black',fontWeight: '500',}}>Create folder</Text>
            <TouchableOpacity
              style={{
