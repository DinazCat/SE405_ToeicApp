...
const {width, height} = Dimensions.get('window');
  ...
  useEffect(() => {
    ...
    return (
        ...
        <TouchableOpacity style={{marginTop:10}}  onPress={() => navigation.push('TeamRoom')}>
            <View style={{width:screenWidth*0.9, height:height*0.1, justifyContent:'flex-start', alignSelf:'center', backgroundColor:card_color, borderRadius:15, borderColor:'gray', borderWidth:1, flexDirection:'row', alignItems:'center'}}>
            <Image
