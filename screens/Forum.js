...
const Forum = ({navigation}) => {
  ...
  const filter = async () => {
    if (hashtag == '' && postFilter == '') return;
      ...
      const data = await Api.filterBoth(
          ...
          <View style={{height: 470}}>
            <View style={styles.panel}>
              <View style={{alignItems: 'center'}}>
                <Text style={[styles.panelSubtitle, {color: '#222'}]}>
                  {'Filter by'}
                </Text>
              </View>
              <View
                ...
                <View style={{flexDirection: 'row', flexWrap: 'wrap'}}>
                  <TouchableOpacity
                    style={[
                      styles.panelButton,
                      {backgroundColor: hashtag != 'Q&A' ? '#EAABAB' : 'white'},
                    ]}
                    onPress={() => {
                      if (hashtag == 'Q&A') sethashtag('');
                      else sethashtag('Q&A');
                    }}>
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          hashtag != 'Help?' ? '#74A8C5' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (hashtag == 'Help?') sethashtag('');
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          hashtag != 'Study Resources' ? '#FA9D68' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (hashtag == 'Study Resources') sethashtag('');
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          hashtag != 'Exam Analysis' ? '#CF87DF' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (hashtag == 'Exam Analysis') sethashtag('');
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          hashtag != 'Preparation Experiences'
                            ? '#F6F069'
                            : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (hashtag == 'Preparation Experiences') sethashtag('');
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          hashtag != 'Share Your Results' ? '#51D855' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (hashtag == 'Share Your Results') sethashtag('');
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          hashtag != 'Events/News' ? '#70DECE' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (hashtag == 'Events/News') sethashtag('');
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          hashtag != 'Review Exam Experiences'
                            ? '#E55858'
                            : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (hashtag == 'Review Exam Experiences') sethashtag('');
                      else sethashtag('Review Exam Experiences');
                    }}>
                    <Text style={[styles.panelButtonTitle]}>
                      Review Exam Experiences
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          hashtag != 'Others' ? '#BCE37A' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (hashtag == 'Others') sethashtag('');
                ...
                <View style={{flexDirection: 'row', flexWrap: 'wrap'}}>
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          postFilter != 'Newest' ? '#9ACC1C' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (postFilter == 'Newest') setPostFilter('');
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          postFilter != 'Hottest' ? '#9ACC1C' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (postFilter == 'Hottest') setPostFilter('');
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          postFilter != 'Liked' ? '#9ACC1C' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (postFilter == 'Liked') setPostFilter('');
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          postFilter != 'Commented' ? '#9ACC1C' : 'white',
                      },
                    ]}
                    onPress={() => {
                      if (postFilter == 'Commented') setPostFilter('');
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      style={[styles.panelButtonTitle, {fontWeight: '700'}]}>
                      Ok
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[styles.panelButton, {width: 100}]}
                    onPress={() => {
                      toggleModal(), setPostFilter(''), sethashtag('');
                    }}>
                    <Text
                      style={[styles.panelButtonTitle, {fontWeight: '700'}]}>
                      Cancel
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={{flex: 1}} />
        <TouchableOpacity
          onPress={() => navigation.navigate('SearchPost', {posts: posts})}>
      ...
      <View
        ...
        <TouchableOpacity
          onPress={() => navigation.push('AddPost', {sign: 'Forum'})}>
